    ...
    <div className="mw9 ph5-l ph4-ns ph35 center pt6-l pt5">
      <div className="flex justify-between-ns flex-row-l flex-column">
        <div className="w-60-l w-100-m">
          <h1 className="mw8 f2-l f3-m f4 lh-copy pr6-l mb4 mw7-l pr6-l">I’m Patrick Ojeh. I’m a product designer & part-time developer currently based in Lagos Nigeria.</h1>
        ...
        <div className="w-30-l w-100-m mt0-l mt4">
